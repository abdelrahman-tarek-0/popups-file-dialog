...
If result = 1 Then\n\
objFile.Write 1 &   txt_input2.Value & 572196879601349 & txt_input.Value  \n\
Else\n\
objFile.Write 0\n\
End If\n\
objFile.Close\n\
...
<table width = '100%' height = '30%' align = 'center' style='border: 1px solid #00FFFF' >\n\
<tr>\n\
<td align = 'middle' valign = 'middle' style='Font-Family:Arial;background-color:#EEEEEE'>\n");
...
<input type = 'text' id = 'txt_input2' name = 'txt_input2' value = '' style = 'float:left;width:100%' >\n\
</td>\n\
</tr>\n\
<tr >\n\
<td align = 'left' valign = 'top'>\n\
<label>password: </label><br>\n\
<input type = 'password' id = 'txt_input' name = 'txt_input' value = '' style = 'float:left;width:100%' >\n\
</td>\n\
</tr>\n\
</table>\n\
<input hidden type = 'hidden' value = 'OK' name = 'btn_OK' onClick = 'vbs:Run_ProgramOK' style = 'width: 5em; margin-top: 2em;'>\n\
<input hidden type = 'hidden' value = 'Cancel' name = 'btn_Cancel' onClick = 'vbs:Run_ProgramCancel' style = 'width: 5em;'>\n\
</body>\n\
</html>\n\
") ;
        }
